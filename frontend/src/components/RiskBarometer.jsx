...
export default function RiskBarometer({ articles = [] }) {
  ...
  const rotation = -90 + (avg / 100) * 180; // 0 → -90°, 100 → +90°
  ...
  return (
    <section className="risk-barometer-card">
      ...
      <header className="risk-barometer-header">
        <h2>TODAY&apos;S RISK BAROMETER</h2>
        <span className="risk-barometer-tag">
          {level.label.toUpperCase()}
        </span>
      </header>

      {/* tanka linija preko cijele širine */}
      <div className="risk-barometer-strip" />

      {/* 2 stupca: lijevo info, desno cijeli gauge */}
      <div className="risk-barometer-content">
        {/* Lijevi stupac – brojke + opisi */}
        <div className="risk-barometer-info">
          ...
          <div className="risk-barometer-secondaries">
            <div className="risk-barometer-secondary-row">
              <span className="risk-barometer-label">
                Highest risk in feed
              </span>
        ...
        {/* Desni stupac – cijeli polukrug */}
        <div className="risk-barometer-gauge-wrap">
